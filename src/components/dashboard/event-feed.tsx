...
import { AlertCircle, RotateCcw, MapPin, Waves } from 'lucide-react';
                ...
                return (
                  <li key={event.eventId}>
                    <button
                      ...
                      className={cn(
                        'w-full rounded-2xl border bg-card text-left transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50',
                        isSelected ? 'border-primary/90 shadow-md' : 'hover:border-primary/30 hover:shadow-sm',
                      )}
                    >
